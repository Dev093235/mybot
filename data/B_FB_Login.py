...
def get_session_manual():
    ...
    """
    options = Options()
    # Uncomment and adjust the binary_location if needed
    # options.binary_location = "/usr/bin/firefox"
    options.headless = False  # Browser visible for manual login
...
def get_session_email():
    ...
    Note: Facebook may block automated login attempts.
    ...
    options = Options()
    options.headless = False  # Browser visible for login (and CAPTCHA if needed)
    options.add_argument("--disable-gpu")
